...
import { Clock, Trash2, Move, CheckCircle } from "lucide-react";
...
export function RecentItems() {
  ...
  const fetchItems = useCallback(async (limit: number, offset: number) => {
    return await backend.item.recent({ limit, offset });
  }, [backend]);
          ...
          <AccordionItem value="recent" className="border-none">
            <AccordionTrigger className="hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-semibold text-[#111827]">Recently Added Items</span>
              </div>
            </AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold text-[#111827]">
                Recently Added Items ({items.length})
              </span>
            </div>
          </AccordionTrigger>
          <AccordionContent>
