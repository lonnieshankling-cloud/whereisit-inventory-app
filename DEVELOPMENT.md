...
```bash
git remote add encore encore://whereisit-inventory-app-9xhi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/whereisit-inventory-app-9xhi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/whereisit-inventory-app-9xhi/settings/integrations/github)
